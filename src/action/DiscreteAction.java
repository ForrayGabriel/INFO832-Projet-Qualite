...
private String/*No type specified!*/ currentLapsTime, ;
	...
	private DiscreteAction() {
		...
		/*
		 * FileHandler logFile; ConsoleHandler logConsole; try{ this.logFile = new
		 * FileHandler(this.getClass().getName() + ".log");
		 * //this.logFile.setFormatter(new SimpleFormatter());
		 * this.logFile.setFormatter(new LogFormatter()); this.logConsole = new
		 * ConsoleHandler(); }catch(Exception e){ e.printStackTrace(); }
		 * this.logger.addHandler(logFile); this.logger.addHandler(logConsole);
		 */
	}
	...
	public void spendTime(int t) {
		...
		this.logger.log(Level.FINE, "[DA] operate spendTime on  " + this.getObject().getClass().getName() + ":"
				+ this.getObject().hashCode() + ": old time " + old + " new time " + this.getCurrentLapsTime());
		// System.out.println( "[DA] operate spendTime on " +
		// this.getObject().getClass().getName() + ":" + this.getObject().hashCode() +
		// ": old time " + old + " new time " + this.getCurrentLapsTime() + "\n");
	}
	...
	public DiscreteActionInterface next() {
		...
		this.logger.log(Level.FINE, "[DA] operate next on  " + this.getObject().getClass().getName() + ":"
				+ this.getObject().hashCode() + ": old time " + old + " new time " + this.getCurrentLapsTime());
		// System.out.println("[DA] operate 'next' on " +
		// this.getObject().getClass().getName() + ":" + this.getObject().hashCode() +
		// ": old time " + old + " new time " + this.getCurrentLapsTime() + "\n");
		return this;
	}
	...
	public boolean hasNext() {
		...
		if (this.timmer != null && this.timmer.hasNext()) {
			 ...
			 * else if (this.dates != null) { more = !this.dates.isEmpty(); }else if
			 * (this.lapsTimes != null) { more = !this.lapsTimes.isEmpty(); }
			 */
		return more;
	}

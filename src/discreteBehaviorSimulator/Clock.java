...
public class Clock {
	 ...
	 * this.lock.lock(); if (this.time < time) { this.time = time; for(ClockObserver
	 * o:this.observers) { o.ClockChange(); } }else{ this.lock.unlock(); throw new
	 * IllegalAccessException("Set time error, cannot go back to the past !!!"); }
	 * this.lock.unlock(); }
	 */

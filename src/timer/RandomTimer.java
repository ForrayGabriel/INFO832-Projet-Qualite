...
private String/*No type specified!*/ distributionParam, ;

	public static enum randomDistribution {
		POISSON, EXP, POSIBILIST, GAUSSIAN;
	}

	// private static String randomDistributionString[] = {"POISSON", "EXP",
	// "POSIBILIST", "GAUSSIAN"};
	...
	public static randomDistribution string2Distribution(String distributionName) {
		return RandomTimer.randomDistribution.valueOf(RandomTimer.randomDistribution.class,
				distributionName.toUpperCase());
	}
	 ...
	 */
	/*
	 * @Override public Integer next(int since){ return this.next(); }
	 */

	/**
	 * Give good mean Give wrong variance
	 */
	...
	/**
	 * Give good mean Give good variance
	 */

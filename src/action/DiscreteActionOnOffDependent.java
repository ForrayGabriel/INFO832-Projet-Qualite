...
private String/*No type specified!*/ method, ;
   private String/*No type specified!*/ object, ;
	...
	/**
	 * Construct an On Off dependence, first action (method) called is On, then
	 * method nextMethod() is called to select the next action. The default behavior
	 * of nextMethod() is to switch between On and Off actions. It can be change by
	 * overloading.
	 * 
	 * @param o
	 * @param on
	 ...
	 */
	/*
	 * public DiscreteActionOnOffDependent(Wo o, Method on, Timer timerOn, Method
	 * off, Timer timerOff){ this.onAction = new DiscreteAction(o, on, timerOn);
	...
	private void dates2Timalapse(TreeSet<Integer> datesOn, TreeSet<Integer> datesOff, Vector<Integer> timeLapseOn,
			Vector<Integer> timeLapseOff) {
	...
	public DiscreteActionOnOffDependent(Object o, String on, TreeSet<Integer> datesOn, String off,
			TreeSet<Integer> datesOff) {
		/*
